    ...
    <section id="home" className="min-h-screen flex items-center pt-20 relative overflow-hidden bg-gradient-to-br from-brand-dark to-brand-charcoal">
      <div className="w-[90%] max-w-[1200px] mx-auto px-5 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="z-10 animate-on-scroll">
            <div className="inline-flex items-center gap-2.5 bg-green-500/10 border border-green-500/30 px-4 py-2 rounded-full text-green-500 text-sm font-semibold mb-5 hover:-translate-y-0.5 transition-all">
            ...
            <h1 className="font-bold  mb-1">HELLO WORLD!<br/></h1>
            <h1 className="text-4xl md:text-6xl font-extrabold leading-[1.1] mb-6">
                THIS IS <span className="bg-gradient-to-r from-brand-red to-brand-light-red bg-clip-text text-transparent">KELFINO.</span><br/>
        ...
        <div className="relative z-10 animate-float flex justify-center animate-on-scroll">
            <div className="relative w-full max-w-[500px] aspect-square group">
                 {/* Pastikan gambar g2.png ada di public/assets/image/ */}
                <img src="/assets/image/g2.png" alt="Kelfino" className="w-[80%] aspect-square object-cover rounded-full shadow-2xl shadow-black/50 grayscale-[20%] contrast-110 transition-all duration-400 group-hover:grayscale-0 group-hover:scale-105 mx-auto relative z-10" />
